...
class Gui:
    ...
    def __init__(self):
        ...
        WindowLabel.configure(background="Blue", font=("Comic Sans MS", 16, "bold"))
    ...
    def check(self):
        ...
        if (self.val.get() == 1):
            ...
            if res > 0.5:
                ...
                resLabel.configure(background="Green", font=("Comic Sans MS", 16, "bold"), fg="red")
            else:
                resLabel = tkinter.Label(self.FirstFrame.getFrames(), text="No Tumor", height=1, width=20)
                resLabel.configure(background="Yellow", font=("Comic Sans MS", 16, "bold"), fg="green")
